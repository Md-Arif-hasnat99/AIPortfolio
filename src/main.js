import './style.css';
import { GEMINI_CONFIG, PORTFOLIO_CONTEXT } from './config.js';
...
function initializeGemini() {
    if (GEMINI_CONFIG.API_KEY && GEMINI_CONFIG.API_KEY.length > 20) {
        try {
...
function getFallbackResponse(message) {
    const responses = {
        ...
        'projects': 'Arif has built several impressive projects: 1. Hostel Sync (React, Next.js, Node.js) - an enterprise management portal. 2. Real Time Weather App (JS, HTML, CSS). 3. Snake Game (Python, Pygame).',
        'hostel': 'Hostel Sync is a high-performance management portal bridging the gap between students and administration. It features real-time synchronization and is built with React, Next.js, and Supabase.',
        'weather': 'The Weather App provides real-time updates and forecasts. It allows users to chat with an AI regarding weather conditions.',
        'snake': 'The Snake Game is a classic implementation using Python and Pygame, featuring score tracking and smooth mechanics.',
        ...
        'default': 'Thanks for your question! I can tell you about Arif\'s skills, projects (like Hostel Sync), education, or experience. What would you like to know?'
    };
